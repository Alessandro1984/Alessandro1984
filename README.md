...
- 📊 In the past semesters I have taught introductory courses in econometrics where students had the opportunity to learn how to manage data, perform descriptive statistics and run linear regressions using R (and several R packages, e.g. *ggplot2*, *dplyr*).
